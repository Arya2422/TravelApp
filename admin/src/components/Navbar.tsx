    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-6 relative">
          <a href="/flight" className="text-gray-800 hover:text-gray-600 font-medium transition">
            Flights
          </a>
          <a href="/train" className="text-gray-800 hover:text-gray-600 font-medium transition">
            Trains
          </a>
          <a href="/buses" className="text-gray-800 hover:text-gray-600 font-medium transition">
            Buses
          </a>
